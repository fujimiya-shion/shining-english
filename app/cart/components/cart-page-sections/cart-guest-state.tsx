...
export function CartGuestState({ returnTo }: { returnTo: string }) {
  return (
    <div className="rounded-3xl border border-border/70 bg-white/90 p-10 text-center shadow-[0_24px_70px_-50px_rgba(15,43,82,0.35)]">
      ...
      <h1 className="mt-6 text-3xl font-semibold text-[color:var(--brand-900)]">Giỏ hàng chưa sẵn sàng</h1>
      <p className="mt-3 text-muted-foreground">
        Đăng nhập để xem giỏ hàng đã lưu, tiếp tục checkout và đồng bộ khóa học trên mọi thiết bị.
      </p>
